...
<style>
    ...
    .stat-card .stat-icon { position: absolute; right: 18px; top: 50%; transform: translateY(-50%); font-size: 52px; opacity: 0.15; z-index: 0; }
    .stat-card .stat-number { font-size: 32px; font-weight: 700; color: #fff; line-height: 1; margin-bottom: 4px; }
    .stat-card .stat-label { font-size: 12px; font-weight: 500; color: rgba(255,255,255,0.85); text-transform: uppercase; letter-spacing: 1px; }
    .stat-card .stat-footer { background: rgba(0,0,0,0.12); padding: 8px 20px; font-size: 11px; color: rgba(255,255,255,0.8); border-top: 1px solid rgba(255,255,255,0.1); }
    ...
    .welcome-card { border-radius: 14px !important; border: none !important; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.08) !important; }
    .welcome-card .card-header { background: linear-gradient(135deg, #001f54, #003087) !important; border-bottom: 3px solid #d4a017 !important; padding: 16px 22px !important; }
    ...
    .welcome-banner { background: linear-gradient(135deg, rgba(0,31,84,0.05), rgba(212,160,23,0.08)); border: 1px solid rgba(212,160,23,0.2); border-left: 4px solid #d4a017; border-radius: 8px; padding: 14px 18px; display: flex; align-items: center; gap: 14px; }
    .welcome-banner .banner-icon { font-size: 36px; color: #d4a017; flex-shrink: 0; }
    .quick-actions-card { border-radius: 14px !important; border: none !important; box-shadow: 0 4px 15px rgba(0,0,0,0.08) !important; overflow: hidden; }
    .quick-actions-card .card-header { background: linear-gradient(135deg, #001f54, #003087) !important; border-bottom: 3px solid #d4a017 !important; padding: 16px 22px !important; }
    ...
    .quick-action-btn { display: flex; align-items: center; gap: 12px; padding: 13px 16px; border-radius: 10px; border: 1.5px solid #e8eaf0; background: #fff; color: #001f54; font-weight: 500; font-size: 13px; text-decoration: none; transition: all 0.25s ease; width: 100%; margin-bottom: 10px; }
    .quick-action-btn i { width: 36px; height: 36px; border-radius: 8px; display: flex; align-items: center; justify-content: center; font-size: 16px; flex-shrink: 0; background: rgba(0,31,84,0.08); color: #001f54; transition: all 0.25s; }
    .quick-action-btn:hover { background: linear-gradient(135deg, #001f54, #003087); color: #fff; border-color: #001f54; text-decoration: none; transform: translateX(4px); }
    .quick-action-btn:hover i { background: rgba(212,160,23,0.3); color: #d4a017; }
    #refreshIndicator { font-size: 11px; color: #888; text-align: right; margin-bottom: 8px; }
    #refreshIndicator.refreshing { color: #d4a017; }
    .role-badge { display: inline-block; padding: 3px 10px; border-radius: 20px; font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 1px; margin-left: 8px; }
    .role-badge-admin   { background: #001f54; color: #fff; }
    .role-badge-support { background: #006064; color: #fff; }
    .role-badge-user    { background: #b8860b; color: #fff; }
</style>
</asp:Content>
            ...
            <div class="stat-card stat-navy">
                <div class="card-body">
                    ...
                    <div class="stat-label">
                        <asp:Label ID="lblTotalLabel" runat="server" Text="Total Tickets" />
                    </div>
                </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 mb-3">
            <div class="stat-card stat-teal">
                <div class="card-body">
                    ...
                    <div class="stat-number">
                        <asp:Label ID="lblResolved" runat="server" Text="0" />
                    </div>
                ...
                <div class="card-body">
                    <div class="welcome-banner">
                        ...
                        <div class="welcome-text">
                            <h5 class="mb-1">
                                Welcome back, <asp:Label ID="lblWelcomeUser" runat="server" Text="User" />!
                                <asp:Label ID="lblRoleBadge" runat="server" />
                            </h5>
                            <p>
                                <asp:Label ID="lblWelcomeMessage" runat="server" Text="Use the sidebar to navigate the system." />
                            </p>
                        </div>
                    </div>
        ...
        <div class="col-lg-4 mb-3">
            <div class="card quick-actions-card">
                ...
                <div class="card-body" style="padding: 16px !important;">
                    ...
                    <%-- View Tickets - everyone --%>
                    <a href="~/Pages/Tickets.aspx" runat="server" class="quick-action-btn">
                        <i class="fas fa-ticket-alt"></i> View All Tickets
                    </a>

                    <%-- Create Ticket - admin and user only --%>
                    <asp:Panel ID="pnlCreateTicketAction" runat="server" Visible="false">
                        <a href="~/Pages/Tickets.aspx" runat="server" class="quick-action-btn">
